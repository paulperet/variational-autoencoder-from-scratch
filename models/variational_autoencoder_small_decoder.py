...
class Decoder(nn.Module):
    ...
    def __init__(self, bottleneck):
        ...
        self.deconv1_1 = nn.ConvTranspose2d(in_channels=512, out_channels=64, kernel_size=3, padding=1)
        self.bn1_1 = nn.BatchNorm2d(num_features=64)
        self.deconv1_2 = nn.ConvTranspose2d(in_channels=64, out_channels=64, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.bn1_2 = nn.BatchNorm2d(num_features=64)

        self.proj1 = nn.ConvTranspose2d(in_channels=512, out_channels=64, kernel_size=1, stride=2, output_padding=1)
        ...
        self.bn2_1 = nn.BatchNorm2d(num_features=64)
        self.deconv2_2 = nn.ConvTranspose2d(in_channels=64, out_channels=64, stride=2, kernel_size=3, padding=1, output_padding=1)
        self.bn2_2 = nn.BatchNorm2d(num_features=64)
        ...
        self.deconv3_1 = nn.ConvTranspose2d(in_channels=64, out_channels=16, kernel_size=3, padding=1)
        self.bn3_1 = nn.BatchNorm2d(num_features=16)
        self.deconv3_2 = nn.ConvTranspose2d(in_channels=16, out_channels=16, stride=2, kernel_size=3, padding=1, output_padding=1)
        self.bn3_2 = nn.BatchNorm2d(num_features=16)

        self.proj3 = nn.ConvTranspose2d(in_channels=64, out_channels=16, kernel_size=1, stride=2, output_padding=1)

        # Fourth block parameters
        self.deconv4_1 = nn.ConvTranspose2d(in_channels=16, out_channels=8, kernel_size=3, padding=1)
        self.bn4_1 = nn.BatchNorm2d(num_features=8)
        self.deconv4_2 = nn.ConvTranspose2d(in_channels=8, out_channels=8, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.bn4_2 = nn.BatchNorm2d(num_features=8)

        self.proj4 = nn.ConvTranspose2d(in_channels=16, out_channels=8, kernel_size=1, stride=2, output_padding=1)

        # Fifth block parameters; stride 2 is used to upsample
        self.deconv5_1 = nn.ConvTranspose2d(in_channels=8, out_channels=3, kernel_size=7, stride=2, padding=3, output_padding=1)
